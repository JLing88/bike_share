...
describe 'As an admin' do
  context 'they visit the show page' do
    context 'they click Edit and fill in the form' do
      it 'displays the updated info on the show page' do
        ...
        fill_in :trip_start_date, with: Date.parse("2017-8-29")
        fill_in :trip_end_date, with: Date.parse("2017-8-29")
