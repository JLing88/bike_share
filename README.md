...
Through web forms allowing users to enter trip/station/weather information
By consuming CSV files with historical information for stations, trips, and weather. In addition to creating and storing this information for viewing at a later date, this application will provide a number of user dashboards with higher level analysis of trends in bike share usage.
Learning Goals
ActiveRecord
...
(no restrictions)
Getting Started
One team member creates a repository with the name of your online bike analysis/ordering platform
Add the other team members and your instructor(s) as collaborators
Add your project to waffle.io to write and track user stories
Create a Pull Request template
Add the user stories to waffle.
Define the Relationship with Your Group
DTR with your group here.
